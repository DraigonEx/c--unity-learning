...
public class TileMapModel : Model<TileApp>, ITileMapModel
{
    ...
    // Below is for a Hex map
    // 13 -> 127 Tiles, 3 Locations
    // 17 -> 217 Tiles, 6 Locations
    // 21 -> 331 Tiles, 9 Locations
    // 25 -> 469 Tiles, 12 Locations (a bit bigger than a normal game size in the board game)
    ...
    [System.NonSerialized] public MapShape Shape;
