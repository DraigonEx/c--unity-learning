...
public class TileMapController : Controller<TileApp> {

	// Use this for initialization
	void Start () {
        GenerateMap(app.model.hexMap.Shape);
	}
    ...
    virtual public void GenerateMap(MapShape mapShape = MapShape.HEX)
    {
        ...
        app.model.hexMap.tiles = new Dictionary<string, Tile>();
        app.model.hexMap.tileKeys = new List<string>();
        app.model.hexMap.tileToGameObjectMap = new Dictionary<Tile, GameObject>();
        app.model.hexMap.gameObjectToTileMap = new Dictionary<GameObject, Tile>();
